...
(function ($) {
    $(document).ready(function () {
        ...
        fluidJSTests.test("toQueryString()", function () {
            // Start with a single key and value.
            var obj = {
                key: "value"
            };
            
            var queryString = fluid.toQueryString(obj);
            jqUnit.assertEquals("The query string should contain the key and value with no trailing &.",
                                "key=value", queryString);
                                
            // Several simple keys in the object.
            obj = {
                key1: 1,
                key2: "2",
                key3: "three"
            ...
            queryString = fluid.toQueryString(obj);
            jqUnit.assertEquals("The query string should contain each key and value separated by &.",
                                "key1=1&key2=2&key3=three", queryString);

            // Object containing an array
            obj = {
                string: "foo",
                number: 42,
                list: ["foo", 42, {}] // Note that we don't currently support nested objects, except to call toString() on them.
            };
            
            queryString = fluid.toQueryString(obj);
            jqUnit.assertEquals("The query string should be a serialized representation of the object's key/value pairs.",
                                "string=foo&number=42&list=foo&list=42&list=%5Bobject%20Object%5D", queryString);
        });
    });
})(jQuery);
