...
(function ($, fluid) {
    ...
    fluid.mergeComponentOptions = function (that, componentName, userOptions) {
        ...
        that.nickName = options.nickName? options.nickName: fluid.computeNickName(that.typeName);    
    };
     ...
     * @return The constructed view object, or <code>null</code> if no nodes could be matched
     * for its container.
     */
    ...
    fluid.invokeGlobalFunction = function (functionPath, args, environment) {
        environment = environment || fluid.environment;
