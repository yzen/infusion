...
/*global jQuery, fluid_1_2, swfobject, SWFUpload*/
...
(function ($, fluid) {
    ...
    var initUploadManager = function (that) {
        var manager = fluid.initSubcomponent(that, 
                                             "uploadManager", 
                                             [that.events, fluid.COMPONENT_OPTIONS, that]);
        return that.options.demo ? fluid.uploader.demoUploadManager(manager) : manager;
    };
    ...
    fluid.defaults("fluid.uploader", {
        ...
        uploadManager: {
            type: "fluid.uploader.swfUploadManager"
        },
